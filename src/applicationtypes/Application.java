...
/**
 * Abstract base class for all application types. Provides common functionality for evaluating
 * different scholarship applications.
 */
public abstract class Application {
  ...
  /**
   * Evaluates the application according to its specific type. This method is implemented by
   * subclasses.
   */
