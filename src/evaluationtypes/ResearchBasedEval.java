...
/**
 * Evaluates research grant applications. Criteria: - At least one Publication (P) or Grant Proposal
 * (GRP) required - Average impact factor >= 1.50 → Full Scholarship - 1.00 <= avg impact < 1.50 →
 * Half Scholarship - avg impact < 1.00 → Rejected - If Research Supervisor Approval (RSV) exists →
 * +1 year extension - Base duration: Full → 1 year, Half → 6 months
 */
