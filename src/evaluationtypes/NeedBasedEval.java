...
/**
 * Evaluates need-based scholarship applications. Criteria: - Monthly income <= 10,000 → Full
 * Scholarship - 10,000 < income <= 15,000 → Half Scholarship - Income > 15,000 → Rejected - If
 * Savings Document (SAV) exists → thresholds increase by 20% - If 3+ dependents → thresholds
 * increase by additional 10% - Duration: 1 year
 */
