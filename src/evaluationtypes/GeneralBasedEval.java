...
/**
 * Handles general eligibility checks that apply to all scholarship types. These checks must pass
 * before specific scholarship criteria are evaluated.
 */
public class GeneralBasedEval extends Evaluation {

  /**
   * Performs general eligibility checks for any scholarship application. Priority order for
   * rejection reasons: 1. Missing Enrollment Certificate 2. Missing Transcript 3. GPA below 2.5 4.
